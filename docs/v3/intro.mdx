...
:::info
Please visit Zoomex's <a href="https://testnet.zoomex.com/zh-TW/user-center/api-manage"> <b>testnet</b></a> or <a href="https://www.zoomex.com/zh-TW/user-center/api-manage"> <b>mainnet</b></a> to generate an API key
:::
...
server_time stands for Zoomex server time, which can be queried via the [Server Time endpoint](https://zoomexglobal.github.io/docs/zh-my/futuresV2/linear/#t-servertime).
:::
