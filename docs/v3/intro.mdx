...
:::tip
- Due to historical reasons, there are two signature methods: [Signature in the request header](./intro#signature-method-1-signature-in-the-request-header) and [Signature in the request body](./intro#signature-method-2-signature-in-the-request-body). For which signature method to use, please refer to the specific interface request demo.
...
### Signature method 1: Signature in the request header
...
### Signature method 2: Signature in the request body
...
|:----- |:-----|----- |
|ret_code / retCode |number |Success/Error code |
|ret_msg / retMsg |string |Success/Error msg. Can be `OK`,`success`,`Success` for Success message|
