...
server_time stands for Zoomex server time, which can be queried via the [Server Time endpoint](https://zoomexglobal.github.io/docs/futuresV2/linear/#t-servertime).
:::
